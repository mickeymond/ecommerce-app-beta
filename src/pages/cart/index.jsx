          ...
          <div class="mx-auto max-w-3xl">
            ...
            <div class="mt-8">
              <ul class="space-y-4">
                ...
                {/* <li class="flex items-center gap-4">
                  <img
                    src="https://images.unsplash.com/photo-1528825871115-3581a5387919?q=80&w=1430&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="banana"
                    class="size-16 rounded object-cover"
                  />

                  <div>
                    <h2 class="text-sm text-gray-900">Banana</h2>
                  </div>
                ...
                <li class="flex items-center gap-4">
                  <img
                    src="https://images.unsplash.com/photo-1573067485648-4cb2618b5e09?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="bell peppers"
                    class="size-16 rounded object-cover"
                  />

                  <div>
                    <h2 class="text-sm text-gray-900">Bell pepper</h2>
                  </div>
