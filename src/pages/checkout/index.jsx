...
import product12 from "../../assets/images/product14.webp";
              ...
              <div class="space-y-6 mt-10">
                <div class="grid sm:grid-cols-2 items-start gap-6">
                  <div class="px-4 py-6 shrink-0 bg-gray-50 rounded-md">
                    <img src={product12} class ="w-full object-contain" />
                  </div>
                  <div>
                ...
                <div class="grid sm:grid-cols-2 items-start gap-6">
                  <div class="px-4 py-6 shrink-0 bg-gray-50 rounded-md">
                    <img src= {product11} class="w-full object-contain" />
                  </div>
                  <div>
                ...
                <div class="grid sm:grid-cols-2 items-start gap-6">
                  <div class="px-4 py-6 shrink-0 bg-gray-50 rounded-md">
                    <img src={product14} class="w-full object-contain" />
                  </div>
                  <div>
                ...
                <div class="grid sm:grid-cols-2 items-start gap-6">
                  <div class="px-4 py-6 shrink-0 bg-gray-50 rounded-md">
                    <img src={product13} class="w-full object-contain" />
                  </div>
                  <div>
